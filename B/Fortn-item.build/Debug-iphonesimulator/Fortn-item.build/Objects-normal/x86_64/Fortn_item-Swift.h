...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Fortn_item",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified pressButton;
- (void)awakeFromNib;
...
- (IBAction)pressedCell:(UIButton * _Nonnull)sender;
